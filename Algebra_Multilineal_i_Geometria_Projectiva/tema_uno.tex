...
\begin{enumerate}[i)]
        ...
        \[
            ...
            \substack{i_1, \cdots, i_p \in \setb{1,\cdots,n} \\
                j_1, \cdots, j_q \in \setb{1,\cdots,n}} \right\}
        \]
...
\begin{proof}
    \begin{enumerate}[i)]
        ...
        \[
            ...
            = \alpha_{I_0J_0} \implies w \text{ l.i.}
        \]
        ...
        \[
            ...
            f(e_{i_1}, \cdots, e_{i_p}, e_{j_1}^*, \cdots, e_{j_q}^*) + 0
        \]
...
\begin{example}
    ...
    \begin{itemize}
        ...
        \[
            u = u(e_1^*) e_1 + \cdots + u(e_n^*) e_n \qquad (B_0^1 = B)
        \]
